...
On a smooth bounded domain with Neumann boundary conditions one arrives at:
\begin{align}
...
Where $H:\R^2 \to \R$ is some harmonic function.
...
Step 1: Solve $1D$ ODE for $f_\varepsilon$ compute initial phase $H$ \\
